...
export function KakaoIcon({ size = 18 }) {
  return (
    ...
    >
      <path
        fill="#000000"
        d="M12 3C6.48 3 2 6.48 2 10.8c0 2.8 1.86 5.25 4.65 6.63-.2.72-.74 2.68-.85 3.1-.13.52.19.51.4.37.17-.11 2.66-1.8 3.74-2.54.67.1 1.36.15 2.06.15 5.52 0 10-3.48 10-7.71C22 6.48 17.52 3 12 3z"
      />
    </svg>
  );
}